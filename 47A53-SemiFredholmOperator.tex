...
\usepackage{pmmeta}
\pmcanonicalname{SemiFredholmOperator}
\pmcreated{2013-03-22 14:17:00}
\pmmodified{2013-03-22 14:17:00}
\pmowner{mhale}{572}
\pmmodifier{mhale}{572}
\pmtitle{semi-Fredholm operator}
\pmrecord{5}{35737}
\pmprivacy{1}
\pmauthor{mhale}{572}
\pmtype{Definition}
...
\begin{document}
A \textbf{semi-Fredholm operator} is a bounded operator between Banach spaces that has a finite dimensional kernel or cokernel, and closed range.
